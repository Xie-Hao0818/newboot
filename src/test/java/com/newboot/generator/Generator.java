...
public class Generator {
    ...
    private static final String USERNAME = "xiehao";
    ...
    private static final String BASE_PACKAGE = "com.newboot";
    ...
    private static final String DATABASE_NAME = "minmao";
    private static final String DATABASE_USERNAME = "root";
    private static final String DATABASE_PASSWORD = "08240030xzh.";
